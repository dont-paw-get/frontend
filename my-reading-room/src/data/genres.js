 ...
 *
 * ⚠️ 확인 필요(백엔드/디자인 합의): 한글 label 표기와 아래 병합 결정
 *   - POETRY_DRAMA: 기존 '시' 흡수
 *   - HUMANITIES: 기존 '심리학'·'철학' 흡수
 *   - MYSTERY_THRILLER: 기존 '추리'·'공포' 흡수 (cat 특화)
 *   - 기존 프론트 전용 장르('여행'·'힐링'·'모험')는 enum 대응이 없어 제거됨
 *   - RELIGION('종교')·COMPUTER_IT('IT·컴퓨터')는 신규 추가
 * genre_type enum 자체는 ERD 기준 확정본. 라벨/별칭만 조정 대상.
 */
